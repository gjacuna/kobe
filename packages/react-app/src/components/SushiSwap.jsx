...
function SushiSwap({ selectedProvider, tokenListURI, userSigner, chainId, address }) {
  ...
  const activeChainId = ChainId.KOVAN;
    ...
    if (tokens) {
      ...
      if (tokenIn) {
        ...
        if (tokenIn === "ETH") {
          ...
          allowance = await makeCall("allowance", tempContractIn, [address, ROUTER_ADDRESS]);
